...
export const language: i18n =
{
	...
	viewCloudPublishHistory: "查看云发布链接历史",
	cloudPublishHistory: {
		title: "云发布链接历史",
		empty: "暂无云发布链接记录。",
		search: "搜索笔记名",
		searchPlaceholder: "输入笔记名...",
		all: "全部",
		noMatches: "没有符合条件的链接记录。",
		linkType: "链接类型",
		presignedUrl: "预签名 URL",
		revocableLink: "可撤销链接",
		entryKey: "入口 object key",
		createdAt: "创建时间",
		expiresIn: "过期秒数",
		expiresAt: "到期时间",
		uploadedCount: "上传数量",
	...
	exportModal:
	{
		...
		sizeEstimate: {
			title: "导出大小预估",
			loading: "正在计算预计 HTML 大小...",
			noFiles: "请选择要导出的文件。",
			estimated: "预计最终 HTML",
			risk: "风险",
			riskLow: "低",
			riskMedium: "中，可能需要较长时间",
			riskHigh: "高，可能导致 Obsidian 长时间导出",
			files: "选中文件",
			pages: "预计页面",
			attachments: "预计附件",
			mediaEmbeds: "媒体嵌入次数",
			inlineMedia: "媒体内联",
			combinedMetadata: "单文件元数据包装",
			attachmentMetadata: "附件内容包装",
			highRiskHint: "建议改用目录导出，或关闭媒体内联后再导出。",
			cancelExport: "取消导出",
			cancelling: "正在取消...",
			failed: "大小预估失败",
		},
